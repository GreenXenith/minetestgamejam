...
### Community Voting
Package reviews will be used to determine a single "Community Winner". Each package will be scored as a percentage calculated with `(total_positive + 1) / (total reviews + 2)`. Reviews with more unhelpful votes than helpful votes (+1 helpful vote) will not count towards the score.  
